...
//         document.getElementById("nombre"), document.getElementById("apellido"), document.getElementById("email");
...
//             a = (document.getElementById("error"), document.getElementById("btnRegistro"), document.getElementById("lista-productos"), document.getElementById("suma-total"), document.getElementById("camisa_evento")),
//             d = document.getElementById("etiquetas");
//         o && o.addEventListener("click", function (o) {
//             if (o.preventDefault(), console.log("has hecho clic en calcular"), "" == e.value) alert("Debes elegir un regalo"), e.focus();
//             else {
